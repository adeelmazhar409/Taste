...
<div class="relative w-full min-h-screen">
  ...
  <!-- Main Content -->
  <div
    class="relative w-full z-10 gap-2 flex flex-col items-center text-white py-6"
  >
    <!-- Logo -->
    ...
    <div class="mt-6 w-full h-12 bg-black/50">

    </div>
    <!-- Main Text -->
    <div
      class="text-5xl text-white font-poiret bg-[#2A0B0B] opacity-70 w-full text-center p-6 mb-2"
    >
